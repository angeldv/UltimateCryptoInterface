// src/main.js
/**
 * Main entry point for UltimateCryptoInterface application
 */
...
class UltimateCryptoInterface {
    /**
     * Create a new UltimateCryptoInterface instance
...
module.exports = UltimateCryptoInterface;
...
if (require.main === module) {
    ...
    const app = new UltimateCryptoInterface({
        input: args.input,
        output: args.output,
